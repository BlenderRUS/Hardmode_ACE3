...
//#########################ZU23
	...
	class RDS_KORD_Base: StaticMGWeapon
	{
		...
		class AnimationSources
		{
			...
			class muzzleHMG_ROT: ReloadAnim {source="ammorandom";};
		};
		armorStructural=10;
		class Library
		{
	...
	class RDS_TOW_TriPod_base: StaticATWeapon
	{
		...
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				minturn = -180;
				maxturn = 180;
				weapons[] = {"Rhs_weap_TOW_Launcher"};
				magazines[] = {"rhs_mag_2Rnd_TOW","rhs_mag_2Rnd_TOW","rhs_mag_2Rnd_TOW"};
...
//				turretInfoType="rds_gui_optic_mortar";
	...
	class RDS_M119_FIA: RDS_M119_AAF {crewMacro(1,mF2,mC2)};
	class RDS_M252_FIA: RDS_M252_AAF {crewMacro(1,mF2,mC2)};
	class RDS_TOW_TriPod_FIA: RDS_TOW_TriPod_AAF {crewMacro(1,mF2,mC2)};
	class RDS_MK19_TriPod_FIA: RDS_MK19_TriPod_AAF {crewMacro(1,mF2,mC2)};
	class RDS_M2StaticMG_FIA: RDS_M2StaticMG_AAF {crewMacro(1,mF2,mC2)};
	class RDS_M2StaticMG_MiniTripod_FIA: RDS_M2StaticMG_MiniTripod_AAF {crewMacro(1,mF2,mC2)};
