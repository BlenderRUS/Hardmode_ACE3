	...
	class hmg_mp_ko_r : hmg_mp_officer_armored
	{
		...
		linkedItems[] = {"rhs_6b26_green","rhs_6b23_6sh92_radio","ItemCompass","ItemWatch","ItemRadio","ACE_NVG_Gen2","ItemMap"};
		respawnLinkedItems[] = {"rhs_6b26_green","rhs_6b23_6sh92_radio","ItemCompass","ItemWatch","ItemRadio","ACE_NVG_Gen2","ItemMap"};
	};	
	class hmg_mp_ko_gv : hmg_mp_officer_armored
	{
		...
		linkedItems[] = {"rhs_6b26_green","rhs_6b23_crewofficer","ItemCompass","ItemWatch","ACE_NVG_Gen2","ItemMap"};
		respawnLinkedItems[] = {"rhs_6b26_green","rhs_6b23_crewofficer","ItemCompass","ItemWatch","ACE_NVG_Gen2","ItemMap"};
		backpack = "tf_mr3000_rhs";
	};	
	...
	class hmg_mp_sergeant : hmg_mp_rifleman
	{
		...
		backpack = "hmg_rif_sidor";
		Items[] = {"FirstAidKit","rhs_acc_1pn93_1","cw_item_notepad","ACE_CableTie","ACE_MapTools"};
		RespawnItems[] = {"FirstAidKit","rhs_acc_1pn93_1","cw_item_notepad","ACE_CableTie","ACE_MapTools"};
	...
	class hmg_mp_razved4ik: hmg_mp_rifleman
	{
		...
		linkedItems[] = {"rhs_6b23_6sh92","rhs_6b26_green","ItemCompass","ItemWatch","ACE_NVG_Gen2"};
		respawnLinkedItems[] = {"rhs_6b23_6sh92","rhs_6b26_green","ItemCompass","ItemWatch","ACE_NVG_Gen2"};
		weapons[] = {"hlc_rifle_aks74u","Throw","Put"}; //rhs_weap_ak74m_folded_dtk
		respawnWeapons[] = {"hlc_rifle_aks74u","Throw","Put"}; //rhs_weap_ak74m_folded_dtk
	};	
